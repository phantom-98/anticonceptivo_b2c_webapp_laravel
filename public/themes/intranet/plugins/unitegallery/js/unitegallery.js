...
function UGThumbsGeneral(){
	...
	var g_options = {
			...
			thumb_border_color: "#00396b",				//thumb border color
			...
			thumb_overlay_color: "#00396b",				//thumb overlay color
...
function UGTileDesign(){
	...
	var g_options = {
			...
			tile_overlay_color: "#00396b",			//tile overlay color
...
function UGSlider(){
	...
	function runSlider(){
	   ...
	   if(g_options.slider_background_color){	   		
		   ...
		   bgColor = g_functions.convertHexToRGB("#00396b", g_options.slider_background_opacity);
		   g_objSlider.css("background-color", bgColor);
...
function UGTextPanel(){
	...
	var g_options = {
			...
			textpanel_bg_color:"#00396b",				//textpanel background color
