    ...
    public function collection(Collection $rows)
    {
        ...
        {            
            if($row['sku']){
                ...
                if($product){
                    $laboratory = Laboratory::whereRaw("UPPER(name) LIKE '%". trim(strtoupper($row['laboratorio'])."%'"))->first(); 
                    $subcategory = Subcategory::whereRaw("UPPER(name) LIKE '%". trim(strtoupper($row['subcategoria'])."%'"))->first(); 
