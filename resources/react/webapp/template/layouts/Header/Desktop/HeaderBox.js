    ...
    useEffect(() => {
        function handleClickOutside(event) {
            if (
                ...
                !refInputSearch.current.contains(event.target) &&
                    ...
                    <div className="col top-do-flex">
                        ...
                        >
                            <input
                                ...
                                placeholder={
                                    "Buscar medicamentos, laboratorios o principio activo"
                                }
                                            ...
                                            <Fragment>
                                                ...
                                                >
                                                    <div className="row mt-2 px-0 mx-0">
                                                        ...
                                                        >
                                                            <span className="d-block font-poppins italic font-11 color-707070">
                                                                {product.laboratory
                                                                    ? product
                                                                          .laboratory
                                                                          .name
                                                            ...
                                                            <span className="font-poppins bold font-14">
                                                                {product.name}
                                                            </span>
                                                        </div>
                                                        <div
                            ...
                            >
                                ...
                                {auth ? (
                                    <div className="col-auto my-auto pl-1">
                                        <div className="font-poppins font-13 lh-12 bold">
                                            Bienvenid@
                                        </div>
                                        <div className="row">
                                            <Link
                                    ...
                                    >
                                        ...
                                        <div className="font-poppins font-13 lh-12 regular">
                                            Inicia sesión
                                        </div>
                                    </div>
                                )}
