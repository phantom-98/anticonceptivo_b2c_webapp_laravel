...
const WaitingPaymentMethod = ({showingWaitingPaymentMethod}) => {

    return(
        <Modal show={showingWaitingPaymentMethod}
               centered
               backdrop="static"
               keyboard={false}
            ...
            <Modal.Body className="px-5 pb-0">
                <div className="row">
                     <div className="col-md-12 text-center mt-4">
                        <h3 className="modal-title">Procesando ingreso de tarjeta</h3>
                    </div> 
...
export default WaitingPaymentMethod