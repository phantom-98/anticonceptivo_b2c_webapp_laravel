    ...
    const handleSubscription = (subscription_plan) => {
        if (subscription == null) {
            ...
            setImageSubscription(
                subscription_plan.subscription_plan.public_image
                    ? subscription_plan.subscription_plan.public_image
                    : noImage
            );
                    ...
                    {product.unit_format && product.format != null ? (
                        <div className="col-12 col-md-12">
                            <div className="product-format-style font-poppins regular color-6C6B6B">
                                Precio por unidad: $
                                {product.state_of_matter === "Liquido"
                                    ? Math.round(
                                          (product.price /
                                              parseInt(product.format)) *
                                              100
                                      ) +
                                      " " +
                                      product.unit_format
                                                ...
                                                <div className="col-12 px-0 subscription-buttons">
                                                    {product.plans.map(
                                                        (item, index) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    className={`btn btn-outline-primary btn-months mr-1 subscription-button-margin ${
                                                                        isActive
                                                                            ? "focus"
                                                                            : ""
                                                                    }`}
