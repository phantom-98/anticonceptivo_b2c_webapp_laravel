    ...
    useEffect(() => {
        if (postCategory.slug) {
            setBreadcrumbs([
                ...breadcrumbs,
                {
                    url: PUBLIC_ROUTES.BLOG_LIST_BY_CATEGORY.path.replace(
                        ":post_type_slug",
                        postCategory.slug
                    ),
        ...
        <Fragment>
            <BasePanelTwo breadcrumbs={breadcrumbs}>
                ...
                <div className="row mt-3 mt-md-5 mb-5">
                    {posts.map((post) => (
                        <div key={uuid()} className="col-md-4 mb-3">
                            ...
                            >
                                ...
                                >
                                    <h4 className="card-text">
                                        No existe contenido para la categoría
                                        seleccionada, por favor vuelva en otro
                                        momento.
                                    </h4>
                                </div>
                            </div>
