    ...
    return (
        <Fragment>
            ...
            >
                ...
                {/*            <div className="row">*/}
                {/*                <div className="col">*/}
                {/*                    <h3 className="font-poppins font-46 bold color-009BE8"*/}
                {/*                        style={{letterSpacing: '2px'}}>{blogName}</h3>*/}
                {/*                </div>*/}
                ...
                {/*                                                    <div*/}
                {/*                                                        className="font-poppins font-14 regular color-009BE8 mb-1 text-uppercase">*/}
                {/*                                                        {*/}
                {/*                                                            (moment(post.published_at).lang('es').format('DD MMM YYYY')).replace('.', '')*/}
                {/*                                                        }*/}
                {/*                                                    </div>*/}
                {/*                                                    <div*/}
                {/*                                                        className="font-poppins font-20 lh-24 bold color-033F5D  mb-2">*/}
                {/*                                                        {post.title}*/}
                {/*                                                    </div>*/}
                {/*                                                    <div>*/}
                {/*                                                        <Link to={postUrl}>*/}
                ...
                {/*                            />*/}
                {/*                            {totalItemsCount ? <label*/}
                {/*                                className="font-poppins font-12 regular paginator-label">Páginas</label> : null}*/}
                {/*                        </div>*/}
                {/*                    </div>*/}
