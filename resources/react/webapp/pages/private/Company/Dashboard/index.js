...
const Dashboard = () => {
    ...
    const getResources = () => {
        let url = Services.ENDPOINT.PANEL.COMPANY.DASHBOARD.GET_RESOURCES;
        let data = {
                ...
                Services.Response({
                    ...
                    success: () => {
                        ...
                        setProjectsInProgress(
                            response.data.projects_in_progress
                        );
                        ...
                        setQuotationsCanceled(
                            response.data.quotations_canceled
                        );
                        setQuotationsAccepted(
                            response.data.quotations_accepted
                        );
                        setQuotationsRejected(
                            response.data.quotations_rejected
                        );
                        setQuotationsFinished(
                            response.data.quotations_finished
                        );
                        setDataLoad(true);
    ...
    return (
        <BasePanel
            title={"Bienvenido " + auth.company.name}
