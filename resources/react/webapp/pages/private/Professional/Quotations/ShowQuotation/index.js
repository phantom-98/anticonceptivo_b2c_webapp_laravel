...
const ShowQuotation = ({match}) => {
    ...
    const getQuotation = (r = '') => {
        ...
        let url = Services.ENDPOINT.PANEL.PROFESSIONAL.QUOTATIONS.GET_QUOTATION;
        ...
        Services.DoPost(url, {
            ...
            Services.Response({
                ...
                success: () => {
                    ...
                    let urlProject = PANEL_PROFESSIONAL_ROUTES.QUOTATIONS_SHOW.path;
