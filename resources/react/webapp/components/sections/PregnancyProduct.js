...
const PregnancyProduct = ({ title, style = '',  middleBanners}) => {
    ...
    const getData = () => {
        let url = Services.ENDPOINT.PUBLIC_AREA.CARROUSELS.GET_PREGNANCY;
        let data = {}
            ...
            <div className="py-3" style={{ background: '#FFFFFF' }}>
                <div className="container">
                    ...
                    <div className="row justify-content-center mt-3 mb-4">
                        <a className='btn btn-bicolor btn-block d-flex my-2 w-auto' href="https://anticonceptivo.cl/tienda/embarazo">
...
export default PregnancyProduct
