...

                        {
                            item.product.offer_price ?
                                <div style={{color: 'black'}}
                                    ...
                                    Precio normal <s>{formatMoney(item.product.price)}</s>
                                </div>
                                : null
                        }

                        {
                            item.subscription ?
                                <div className="d-block d-md-none col-auto font-poppins font-12 regular">
                                    {' (' + formatMoney(item.subscription.price) + ' c/u)'}
                                </div>
                                : null
                                        ...
                                        <div className="col-12 col-md-auto d-flex">
                                            <div className="my-auto font-poppins font-23 bold color-009BE8 text-right">
                                                ...
                                                <br/>
                                                {
                                                    item.product.offer_price ?
                                                        <div style={{color: 'black'}}
                                                             className="font-poppins font-12 lh-12 regular">Precio
                                                            Normal {formatMoney(item.product.price)} </div>
                                                        : null
                                                }
                                            </div>
                                        </div>
                                        <div className="col-auto pt-1 text-center pointer"
...

                                    {
                                        item.subscription == null ?
                                            ...
                                            <div className="text-right font-poppins font-14 bold color-009BE8 mb-auto">
                                                {formatMoney(item.subscription.price * item.subscription.quantity * item.quantity)}
                                            </div>
                                    }

                                    <div className="text-right pointer mt-auto" onClick={() => removeFromCart(item)}>
