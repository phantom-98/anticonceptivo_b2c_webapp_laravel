...
const TotalCartPriceFinal = ({
    ...
    useEffect(() => {
        ...
        let _total_discount =
            discount === 0
                ...
                : (discountType === 0
                      ? discount
                      : Math.round(subtotal * discount)) * -1;
        let _sub_total = 0;
    ...
    return (
        <Fragment>
            ...
            <div className="row">
                <div className="col-auto">
                    <h3 className="font-poppins font-12 regular color-1F1F1F">
                        Costo despacho
                    </h3>
                </div>
                <div className="col text-right">
                    <h3 className="font-poppins font-12 regular color-1F1F1F">
                        {formatMoney(dispatch)}
                    </h3>
                </div>
            </div>
            <div className="row">
                <div className="col-auto">
                    <h3 className="font-poppins font-12 bold color-033F5D">
                        Total Descuento
                    </h3>
                </div>
                <div className="col text-right">
