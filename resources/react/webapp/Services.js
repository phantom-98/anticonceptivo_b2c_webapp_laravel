...
export const ErrorCatch = (error) => {
    ...
    const httpErrors = [200, 400, 401, 402, 403, 404, 500, 503];
    if (httpErrors.includes(error.response.status)) {
        console.log(error.response.data.message);
    } else {
        console.log(
            "Ha ocurrido un error inesperado, por favor comuníquese con el administrador. " +
                error
        );
    }
};
...
export const ENDPOINT = {
    ...
    PUBLIC_AREA: {
        ...
        CARROUSELS: {
            ...
            GET_BRANDS: GetBaseURL() + "public-area/get-brands",
        },
        CORPORATE_RESPONSIBILITY:
            GetBaseURL() + "public-area/get-corporate-responsabilities",
        BLOG: {
            ...
            POSTS_RECOMMENDED:
                GetBaseURL() + "public-area/get-posts-recommended",
            GET_POSTS_BY_CATEGORY:
                GetBaseURL() + "public-area/get-posts-by-category",
        },
        ...
        SHOP: {
            ...
            PRODUCTS: {
                CATEGORY:
                    GetBaseURL() + "public-area/get-product-by-categories",
                SEARCH: GetBaseURL() + "public-area/get-product-by-search",
                SUBCATEGORY:
                    GetBaseURL() + "public-area/get-product-by-subcategories",
    ...
    NO_AUTH: {
        ...
        SHOP: {
            ...
            PRODUCTS_FILTERED:
                GetBaseURL() + "public-area/get-products-filtered",
            PRODUCTS_SEARCH_FILTER:
                GetBaseURL() + "public-area/get-product-by-filtered-search",
        },
        PRODUCT: {
        ...
        CHECKOUT: {
            ...
            SUBMIT_PRESCRIPTION:
                GetBaseURL() + "public-area/submit-prescription",
    ...
    CUSTOMER: {
        ...
        ADDRESSES: {
            ...
            SET_DEFAULT_ADDRESS:
                GetBaseURL() + "customer/update-default-address",
        ...
        SUBSCRIPTIONS: {
            ...
            SET_DEFAULT_SUBSCRIPTION:
                GetBaseURL() + "customer/update-default-subscription",
            ...
            GET_SUBSCRIPTIONS_ORDERS_ITEMS:
                GetBaseURL() + "customer/get-subscriptions-orders_items",
            GET_ACTIVE_SUBSCRIPTIONS_ORDERS_ITEMS:
                GetBaseURL() + "customer/get-active-subscriptions-orders_items",
            SET_ADDRESS_SUBSCRIPTION:
                GetBaseURL() + "customer/set-address-subscription",
            SET_CARD_SUBSCRIPTION:
                GetBaseURL() + "customer/set-card-subscription",
            SET_DISPATCH_DATE_SUBSCRIPTION:
                GetBaseURL() + "customer/set-dispatch-date-subscription",
            SET_CANCEL_SUBSCRIPTION:
                GetBaseURL() + "customer/cancel-subscription-item",
            GET_VALID_DATES_FOR_DISPATCH_DATE:
                GetBaseURL() + "customer/get-valid-dates-for-dispatch-date",
        },
        ORDERS: {
