...
const CompanyMiddleware = ({path: path, component: Component, layout: Layout, title, exact}) => {
    ...
    return (
        load ?
            <Route exact={exact} path={path} render={(props) => {
                ...
                if (authType !== AuthType.COMPANY || !auth) {
                    return (
...
export default withRouter(CompanyMiddleware);
