                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="size" name="size" class="form-control">
                                                        <option value="col-md-3" {{ $slider->size == "col-md-3" ? 'selected': ''}}>25% de la pantalla</option>
                                                        <option value="col-md-4" {{ $slider->size == "col-md-4" ? 'selected': ''}}>33% de la pantalla</option>
                                                        <option value="col-md-6" {{ $slider->size == "col-md-6" ? 'selected': ''}}>50% de la pantalla</option>
                                                        <option value="col-md-8" {{ $slider->size == "col-md-8" ? 'selected': ''}}>75% de la pantalla</option>
                                                        <option value="col-md-9" {{ $slider->size == "col-md-9" ? 'selected': ''}}>80% de la pantalla</option>
                                                        <option value="col-md-12" {{ $slider->size == "col-md-12" ? 'selected': ''}}>100% de la pantalla</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="size" name="size" class="form-control">
                                    ...
                                    <option value="col-md-3">25% de la pantalla</option>
                                    <option value="col-md-4">33% de la pantalla</option>
                                    <option value="col-md-6">50% de la pantalla</option>
                                    <option value="col-md-8">75% de la pantalla</option>
                                    <option value="col-md-9">80% de la pantalla</option>
                                    <option value="col-md-12">100% de la pantalla</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
