                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="size" name="size" class="form-control">
                                                        <option value="col-md-3" {{ $slider->size == "col-md-3" ? 'selected': ''}}>25% de la pantalla (300x388)</option>
                                                        <option value="col-md-4" {{ $slider->size == "col-md-4" ? 'selected': ''}}>33% de la pantalla (433x388)</option>
                                                        <option value="col-md-6" {{ $slider->size == "col-md-6" ? 'selected': ''}}>50% de la pantalla (566x388)</option>
                                                        <option value="col-md-8" {{ $slider->size == "col-md-8" ? 'selected': ''}}>75% de la pantalla (750x388)</option>
                                                        <option value="col-md-9" {{ $slider->size == "col-md-9" ? 'selected': ''}}>80% de la pantalla (920x388)</option>
                                                        <option value="col-md-12" {{ $slider->size == "col-md-12" ? 'selected': ''}}>100% de la pantalla (1080x388)</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
