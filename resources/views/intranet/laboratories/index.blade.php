                ...
                <div class="panel-body">
                    ...
                    <div id="toolbar">
                        <a href="{{ route($config['route'] . 'create') }}" class="btn btn-success"><i
                                    class="ti-plus"></i> Nuevo Laboratorio</a>
                    ...
                    <table id="table-bs"
                        ...
                        <tr>
                            ...
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">Nombre Corporativo</th>
