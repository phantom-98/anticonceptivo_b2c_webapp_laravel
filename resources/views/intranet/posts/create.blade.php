                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="post_type_id" name="post_type_id" class="form-control select2" data-width="100%">
                                        ...
                                        @foreach($types as $c)
                                            <option value="{{ $c->id }}" {{ old('post_type_id') == $c->id ? 'selected' : ''}}>{{ $c->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" rows="3" style="resize: none" class="summernote" required>{{ old('content') }}</textarea>
                                </div>
                            </div>
