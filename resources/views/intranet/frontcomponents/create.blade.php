                        ...
                        <div class="row">
                                ...
                                <div class="form-group {{ $errors->has('front_component_category_id') ? 'has-error':'' }}">
                                    ...
                                    @if (count($frontComponentCategories)>0)
                                        @foreach ($frontComponentCategories as $frontComponentCategoriesItem)
                                            <option value="{{$frontComponentCategoriesItem->id}}">{{$frontComponentCategoriesItem->name}}</option>
                                        @endforeach
                                    @endif
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('full_description') ? 'has-error':'' }}">
                                    ...
                                    <textarea name="full_description" id="content" rows="3" style="resize: none">{{ old('full_description') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('short_description') ? 'has-error':'' }}">
                                    ...
                                    <textarea name="short_description" id="contentshort" rows="3" style="resize: none">{{ old('short_description') }}</textarea>
