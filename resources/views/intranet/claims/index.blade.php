        ...
        <div class="col-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form id="changeStatusTicket" action="{{ route('intranet.claims.reply') }}" method="post" enctype="multipart/form-data">
                        @csrf()
                    </form>
                </div>
            </div>
        ...
        $(document).ready(function () {
            ...
            let columns = [
                ...
                },
                {
                    ...
                    cellStyle: cellStyle,
                    formatter: function (value, row, index) {
                        return "<div class='btn-group' style='width: max-content;'><a onclick='openModalContenido(" + row.id + ")' class='btn btn-sm btn-default btn-hover-success' data-toggle='tooltip' title='Ver contenido'><i class='fa fa-search'></i></a></div>";
                    }
                },
                {
                    title: 'Estado',
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        if(row.reply){
                            return "<div class='btn-group' style='width: max-content;'><a onclick='openModalRespuesta(&quot;" + row.reply.replace(/(?:\r\n|\r|\n)/g, '<br>') + "&quot;)' class='btn btn-sm btn-default btn-hover-success' data-toggle='tooltip' title='Ver respuesta'><i class='fa fa-search'></i></a></div>";
                        } else {
            ...
            columns.push({
                ...
                formatter: function (value, row, index) {
                    ...
                    if(row.is_reply == 0){
                        ...
                        prepend = "<a onclick='"+functionV+"' class='btn btn-sm btn-default btn-hover-info' data-toggle='tooltip' title='Cambiar estado'><i class='fa fa-retweet'></i></a>";
                    } else {
                        prepend = "-";
                    }
