                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="banner_image_size" name="banner_image_size" class="form-control">
                                        ...
                                        <option value="col-md-12" {{ $object->banner_image_size == "col-md-12" ? 'selected': ''}}>100% de la pantalla (1900x512)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="subbanner_image_size" name="subbanner_image_size" class="form-control">
                                        ...
                                        <option value="col-md-12" {{ $object->subbanner_image_size == "col-md-12" ? 'selected': ''}}>100% de la pantalla (1900x512)</option>
                                    </select>
                                </div>
                            </div>
