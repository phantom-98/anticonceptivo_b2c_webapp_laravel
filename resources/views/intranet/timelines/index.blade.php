                ...
                <div class="panel-body">
                    ...
                    <div id="toolbar">
                        <a href="{{ route($config['route'] . 'create') }}" class="btn btn-success"><i
                                    class="ti-plus"></i> Nuevo Elemento</a>
                    ...
                    <table id="table-bs"
                        ...
                        <tr>
                            ...
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">Año</th>
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">Blog Relacionado</th>
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">ícono</th>
