                ...
                <div class="panel-body">
                    ...
                    <div id="toolbar">
                        <a href="{{ route($config['route'] . 'create') }}" class="btn btn-success"><i
                                    class="ti-plus"></i> Nuevo precio</a>
                    ...
                    <table id="table-bs"
                        ...
                        <thead>
                        <tr>
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">Precio</th>
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">Fecha Inicio</th>
                            <th data-sortable="true" data-cell-style="cellStyle"  data-valign="middle">Fecha Término</th>
                        ...
                        <tbody id="psP">
                            ...
                            @foreach($objects as $object)
                                <tr>
                                    <td>${{ number_format($object->price, 0, ',','.')}}</td>
                                    <td>{{ date('d-m-Y', strtotime($object->start_date)) }}</td>
                                    <td>{{ $object->due_date ? date('d-m-Y', strtotime($object->due_date)) : 'Vigente' }}</td>
                                    @if($config['action']['changeStatus'])
