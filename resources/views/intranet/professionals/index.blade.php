                                ...
                                <form id="form" action="{{ route($config['route'] . 'index') }}"
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select id="area_id" name="area_id" class="form-control select2" data-width="100%">
                                                <option value="">Todas</option>
                                                @if($area_id)
                                                <option value="{!! $area_id!!}" selected>{!! $nameArea!!}</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div> 
            ...
            let columns = [
                {
                    ...
                    formatter : function (value, row, index){
                        let img = '{{ Storage::url('public/professionals/:id') }}';
                ...
                // },
                {
                    ...
                    cellStyle: midAling,
                    formatter : function (value, row, index){
                        if (row.is_freelance && !row.is_agency) {
                            return "Freelance";
                        }
...
<script>
    $(document).ready(function(){
        $('#area_id').select2({
            ...
            ajax: {
                url: '{{route('intranet.professionals.search_area')}}',
                dataType: 'json',
